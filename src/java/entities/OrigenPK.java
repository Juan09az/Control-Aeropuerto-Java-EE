...
public class OrigenPK implements Serializable {
    ...
    public OrigenPK(String codVuelo, String iata) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OrigenPK)) {
            return false;
        }
        OrigenPK other = (OrigenPK) object;
    ...
    public String toString() {
        return "entities.OrigenPK[ codVuelo=" + codVuelo + ", iata=" + iata + " ]";
    }
